...
const Banner1 = () => {
  return (
    <section className='flex flex-col md:flex-row container gap-10 pb-20 items-center'>
        <div>
            <motion.img initial={{opacity: 0, scale: 0}} whileInView={{opacity: 1, scale: 1}} transition={{duration: 0.5, delay: 0.5}} className='md:w-[600px]' src={banner1Img} alt="banner1" />
        </div>
